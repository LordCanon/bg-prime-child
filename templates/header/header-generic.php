...
<header id="masthead" class="<?php echo basename( __FILE__, '.php' ); ?>" role="banner" <?php BoldGrid_Framework_Schema::header( true ); ?>>
	<?php do_action( 'boldgrid_header_top' ); ?>
		...
		<div class='boldgrid-section color1-background-color'>
		...
		<div class='boldgrid-section'>
			<div class="bgtfw <?php echo $configs['template']['pages']['global']['header']; ?>">
				...
				<div class='row header-2 header-3 header-4'>
					<div class='col-md-12 header-2'><?php do_action( 'boldgrid-theme-location', 'header', '2' ); ?></div>
					<div class='col-md-12 header-3'><?php do_action( 'boldgrid-theme-location', 'header', '3' ); ?></div>
					<div class='col-md-12 header-4'><?php do_action( 'boldgrid-theme-location', 'header', '4' ); ?></div>
				</div>
